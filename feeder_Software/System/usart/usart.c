...
void Btn_Clicked(void)
{
	...
	if(rx_buffer[74] == '1')
	{
		...
		else if(rx_buffer[77] == '0')
		{
			Auto_Feed_Global = 0;
		}
	}
	/* 手动小份 */
	else if(rx_buffer[74] == '2')
	{
		OLED_ShowNum(4, 3, n++, 1);
	}
	/* 手动中份 */
	else if(rx_buffer[74] == '3')
	{
		OLED_ShowNum(4, 5, n++, 1);
	}
	/* 手动大份 */
	else if(rx_buffer[74] == '4')
	{
		OLED_ShowNum(4, 7, n++, 1);
	}
	else{
